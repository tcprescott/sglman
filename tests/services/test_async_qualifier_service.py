...
# ---------------------------------------------------------------------------
# The reads the admin drill-down was split onto: a projected leaderboard read and
# a per-runner tally that scales with the review queue rather than the tournament.
