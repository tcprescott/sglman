...
- [bracket-ui-plan.md](bracket-ui-plan.md) — **proposed** redesign of the bracket/Swiss/groups presentation layer to the canonical Challonge/start.gg/Liquipedia visual grammar (connector-lined match cards with seeds/avatars/scores, round headers with best-of and times, tiebreaker columns, advancement tinting), with the 2026-07 bracket-UI research record (layout techniques, library survey).
