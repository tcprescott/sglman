...
|---|---|---|---|---|
| 1 | ~~1-stage-notifications.md~~ | **Shipped.** Assigning or clearing a stage DMs the players and approved crew, and a worker reminds them before the match | no | yes (2 columns) |
...
Plan 3 is all that is left: the only one carrying a new flag, a leak test and
seed rows.
