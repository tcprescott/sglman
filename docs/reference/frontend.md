...
| Proctor Station | proctor or staff | `admin_tabs/admin_schedule.py:admin_schedule_page` | Race/schedule workflow — lifecycle buttons + seed rolls; `can_crud=is_staff` (proctors get transition-only) |
