...
5. Default `ServiceTableView` to the styled table family and add the class to hand-rolled admin tables (C1); standardize booleans → icon/chip, statuses → `.sgl-chip`, empty markers → `—` (C2, C3, E4).
