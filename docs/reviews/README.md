...
| [volunteer-hub-ux.md](volunteer-hub-ux.md) | Coordinator grid + the volunteer's own tabs | "Draft" is a concept only the coordinator's screen honours — the volunteer sees provisional shifts as commitments and loses them silently — **being remediated in [plans/volunteer-hub/](../plans/volunteer-hub/README.md)** |
