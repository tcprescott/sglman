...
| **§3.5** | Drop "unlike the Challonge/Twitch/Discord endpoints" — those upstream base URLs are **equally hardcoded**; only SGLMan's own OAuth callback URLs are env-overridable. |
