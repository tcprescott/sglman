# Wizzrobe — Current Project State

_Last updated: 2026-07-19_

## What Is This

Wizzrobe manages tournament schedules, matches, users, and crew for tournament events. It runs as a single Docker container: FastAPI backend + NiceGUI frontend + Discord bot, backed by PostgreSQL.
...
application/repositories/ ← ORM queries (Tortoise)
  ↓ uses
models/                 ← Tortoise models (58) + enums (22: Role, RoleSource, FeatureFlag, BracketFormat, MatchNotificationLevel, …), per-domain submodules re-exported from models/__init__.py
```
