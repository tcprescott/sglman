...
CAT_FACT_SECTIONS: dict[str, list[str]] = {
    ...
    'Ailments, and the good news': [
        "Feline diabetes often goes into remission — a low-carb diet gets plenty of cats off insulin entirely.",
        "Hyperthyroidism has an actual cure: one dose of radioactive iodine fixes around 95% of cats, once.",
        "Chronic kidney disease is manageable rather than terminal — caught early, cats live years on diet and fluids.",
        "GS-441524 turned FIP from a death sentence into a course of treatment most cats walk away from.",
        "Cats with FIV usually live a normal lifespan; it spreads through deep bite wounds, so a settled household stays safe.",
        "Ringworm sounds dreadful and mostly clears on its own; treatment just shortens the wait.",
        "Cats do fine without teeth — after full-mouth extractions most eat better than they did with sore gums.",
        "Feline arthritis got its first monoclonal antibody in 2022: one monthly injection, and stiff old cats start jumping again.",
        "Three-legged cats are back to climbing the furniture within weeks; the other three legs were always doing most of the work.",
        "Blind cats map a house from memory and whiskers, and visitors routinely fail to notice.",
        "Deaf cats read footsteps through the floor, which is why they still meet you at the door.",
        "Asthmatic cats use an inhaler with a little face mask, and take to it faster than you'd expect.",
        "Most hairball trouble is solved with a brush — fur collected by you is fur not swallowed.",
        "Cats hide illness, but senior bloodwork doesn't: routine panels catch kidney and thyroid changes years ahead of symptoms.",
    ],
    'Coats and genetics': [
