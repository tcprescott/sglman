...
before you start, and be careful about power, since the plug you pull may be
running the station next to you.
:::
...
make on the spot, since an admin makes the call, so raising it early is the
fastest route.
:::
...
Collect your things and leave the seat genuinely free, since the next pair are
usually waiting. You do not need to do anything in the app: the station
