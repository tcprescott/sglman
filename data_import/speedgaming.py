# This is a crude ETL script to import data from SpeedGaming's API into the local database.
# This script also contains coroutines to update specific data in the database on demand.
...
class SGEventNotFoundException(Exception):
    pass
