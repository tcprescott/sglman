...
- **theme/dialog/** & **theme/tables/**: Custom dialog and table components for UI interactions (e.g., `UserDialog`, `MatchTableView`).
...
- **Async/await**: All DB and UI actions are async; dialogs and page actions use async functions.
...
- To add a dialog: create a class in `theme/dialog/`, use NiceGUI components, and call from a page or table.
